...
public class Personal {
	...
	public Personal(String ident, String nom, String ape, LocalDate fech, String direc, String codPos, String local
			, String pai, ObservableList<Nacionalidad> nac) {
		identificacion.set(ident);
		nombre.set(nom);
		apellidos.set(ape);
		fechaNacimiento.set(fech);
		direccion.set(direc);
		codigoPostal.set(codPos);
		localidad.set(local);
		pais.set(pai);
		nacionalidades.addAll(nac);
	}
